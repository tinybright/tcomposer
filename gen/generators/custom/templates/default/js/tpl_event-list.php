...
<!--                <input time="show" format="YYYY-MM-DD" def-laydate1 class="form-control msg-detail laydate-icon laydate-icon-default cursor date-selector hidden" type="text" name="info[date]" ng-model="{$samplectrl}LC.{$lowerctrl}LogSearch.search.keywords.date" readonly >-->
<!--                <p class="input-group uib-date-picker">-->
...
<!--                    <button type="button" class="btn btn-default" ng-click="{$samplectrl}LC.date.open()"><i class="glyphicon glyphicon-calendar"></i></button>-->
<!--                  </span>-->
<!--                </p>-->
<!--            </div>-->
            <div class="weui-cell__bd">
...
<page class="page-{$linectrl}-list  page-list page-list-new">
    <button class="btn btn-dark" type="button" ng-click="{$samplectrl}LC.add{$camelctrl}();">添加</button>
    <div class="">
        <div  ui-grid="{$samplectrl}LC.grid.options" ui-grid-edit ui-grid-pagination
